<div>
    ...
    <div class="production-info row row-gap-1 justify-content-center align-items-end mb-3">
        ...
        <div class="col-md-auto">
            <div class="mb-1" wire:ignore>
                <a href="{{ $this->baseUrl."/production-panel/".$orderInfo->id."/qr" }}" class="btn btn-danger btn-sm w-auto fw-bold"><i class="fa-solid fa-rotate"></i> MANUAL</a>
            </div>
        </div>
    </div>
    ...
    @if (!$panels)
        {{-- Back --}}
        <a wire:click="toProductionPanel" class="back bg-danger text-light text-center w-auto">
