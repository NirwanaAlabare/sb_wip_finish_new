...
class Rft extends Component
{
    ...
    protected $rules = [
        'sizeInput' => 'required',
        'noCutInput' => 'required',
        'numberingInput' => 'required|unique:output_check_finishing,kode_numbering|unique:output_defects_packing,kode_numbering|unique:output_rejects_packing,kode_numbering',
    ];
    ...
    public function updateOutput()
    {
        ...
        $this->rft = DB::connection('mysql_sb')->table('output_check_finishing')->
            where('master_plan_id', $this->orderInfo->id)->
            where('status', 'NORMAL')->
